      ...
      <div className="flex-1 overflow-y-auto p-6 flex items-center justify-center">
        <Card className="max-w-md w-full text-center py-12 p-8 shadow-xs border border-border-color bg-bg-card">
          ...
          <p className="text-xs text-text-secondary mt-2 leading-relaxed">
            Para ver o seu perfil aqui, use a extensão do Chrome **JobFinder Sync** para sincronizar as suas credenciais e perfil do LinkedIn.
          </p>
          <Button
            variant="primary"
  ...
  return (
    <div className="flex-1 overflow-y-auto p-6 space-y-6 animate-fadeIn">
      ...
      <div className="flex justify-between items-center">
        <div>
          <h1 className="text-2xl font-bold text-text-primary">Meu Perfil do LinkedIn</h1>
          <p className="text-xs text-text-secondary mt-0.5">Veja os dados profissionais sincronizados do seu LinkedIn</p>
        </div>
        <Button
          variant="secondary"
          size="sm"
        ...
        <div className="w-24 h-24 md:w-28 md:h-28 rounded-full border-4 border-bg-card absolute left-6 top-20 md:top-28 bg-bg-hover flex items-center justify-center overflow-hidden shadow-sm z-10 transition-colors duration-200">
          {photoUrl ? (
            <img 
              ...
              onError={(e) => {
                // Handle image failure gracefully
            ...
            <div className="flex-1 min-w-0">
              ...
              {profile.profileId && (
                <div className="flex items-center gap-1.5 mt-2 text-[10px] text-text-secondary/70">
                  ...
                  <span>Sincronizado via Extensão</span>
                </div>
              )}
            </div>
          </div>
