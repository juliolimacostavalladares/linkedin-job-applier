...
<Cards>
  ...
  <Card title="LinkedIn SDK" href="/docs/sdk">
    Biblioteca portátil e desacoplada que encapsula todos os serviços em um único pacote importável com suporte a modo direto e HTTP.
  </Card>
