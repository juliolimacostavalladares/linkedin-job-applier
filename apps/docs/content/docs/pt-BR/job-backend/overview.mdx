...
O **Job Backend** (`apps/linkedin-job-backend`) é o orquestrador central para busca de vagas e automação de candidaturas. Gerencia o ciclo completo: desde buscar vagas e gerar respostas com IA até rastrear status de candidaturas.
