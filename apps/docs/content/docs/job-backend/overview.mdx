...
The **Job Backend** (`apps/linkedin-job-backend`) is the core orchestrator for job search and application automation. It manages the full lifecycle: from searching jobs and generating AI-powered answers to tracking application statuses.
